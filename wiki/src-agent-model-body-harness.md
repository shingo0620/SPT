...
| **Harness** | 會搬家但不會消失——它在解的不是「model 弱」的問題，是「LLM 本質 non-deterministic」的問題。[[Sonnet 4.6\|Sonnet]] 4.5 的 context anxiety scaffolding 在 Opus 4.6 時代拆掉，但同時間天花板上移、新失敗模式跑出來、新 scaffolding 又長出來 |
