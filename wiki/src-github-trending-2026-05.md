...
| # | Repo | 星 | 語言 | 主題 | 查核 | 連結 |
|---|------|----|------|------|------|------|
| 1 | ~~NamKhoa-07/Voidstrap~~ | ~~482~~ | ~~C#~~ | ❌ Roblox 注入器 fork（Bloxstrap 的灰色版） | ❌ | [GitHub](https://github.com/NamKhoa-07/Voidstrap) |
| 2 | ~~WeritoP/BetterNitroDiscord~~ | ~~463~~ | ~~—~~ | ❌ BetterDiscord 解鎖 Nitro 功能（盜版插件） | ❌ | [GitHub](https://github.com/WeritoP/BetterNitroDiscord) |
| 3 | ~~432539/plus_gopay_gptp-plus~~ | ~~163~~ | ~~JS~~ | ❌ GPT Plus 開通灰色管道 | ❌ | [GitHub](https://github.com/432539/plus_gopay_gptp-plus) |
| 4 | yaojingang/yao-open-prompts | 150 | Python | 中文 AI prompt 庫，工作/學習/內容/行銷/生活情境 | ✅ | [GitHub](https://github.com/yaojingang/yao-open-prompts) |
| 5 | cv-cat/XHS_ALL_IN_ONE | 127 | JS | 小紅書全域運營（爬取/帳號管理） | ⚠️ | [GitHub](https://github.com/cv-cat/XHS_ALL_IN_ONE) |
| 6 | ~~Predictional-Infra/polymarket-trading-bot~~ | ~~90~~ | ~~TS~~ | ⚠️ Polymarket arbitrage bot（描述為 SEO keyword 重複疊字） | ⚠️ | [GitHub](https://github.com/Predictional-Infra/polymarket-trading-bot) |
| 7 | ~~Predictional-Infra/polymarket-copy-trading-bot~~ | ~~90~~ | ~~TS~~ | ⚠️ Polymarket copy trading bot（同帳號刷榜，同樣 SEO 關鍵字疊字） | ⚠️ | [GitHub](https://github.com/Predictional-Infra/polymarket-copy-trading-bot) |
| 8 | gofsnotify/fsnotify | 56 | Go | 跨平台 file system notifications for Go（fork） | ✅ | [GitHub](https://github.com/gofsnotify/fsnotify) |
| 9 | **rihebty/flow-kit** | 35 | — | **融合 bmad、spec-kit、OpenSpec、GSD、claude-task-master、superpowers、gstack、skills 的 AI 編程規範化流程** | ✅ | [GitHub](https://github.com/rihebty/flow-kit) |
| 10 | ~~mereses-labs/solana-pumpfun-bundler~~ | ~~34~~ | ~~TS~~ | ❌ Solana pumpfun bundler（stealth-mode、bubblemap-bypass）——明顯為灰色洗錢/搶跑工具 | ❌ | [GitHub](https://github.com/mereses-labs/solana-pumpfun-bundler) |
| 11 | TQ-trade-agent/taco-web | 33 | Vue | TypeScript client for TACo（Threshold Access Control） | ✅ | [GitHub](https://github.com/TQ-trade-agent/taco-web) |
| 12 | lightseekorg/tokenspeed | 31 | Python | speed-of-light LLM inference engine（支援 blackwell/deepseek/gpt-oss/kimi） | ✅ | [GitHub](https://github.com/lightseekorg/tokenspeed) |
| 13 | reakjra/omikuji | 25 | Rust | Qt/QML based game launcher for Linux | ✅ | [GitHub](https://github.com/reakjra/omikuji) |
| 14 | dhDSouza/UC2_TDS26-1M | 25 | — | 無描述（疑為作業/教學 repo） | ⚠️ | [GitHub](https://github.com/dhDSouza/UC2_TDS26-1M) |
| 15 | 2234839/ai-nvr | 22 | TS | 無描述（推測 AI 影像錄製/分析） | ⚠️ | [GitHub](https://github.com/2234839/ai-nvr) |

> **05-06 觀察**——**信號劣化延續，但出現 1 個值得關注 repo**：
>
> - 15 條中：4 ❌（Voidstrap、BetterNitroDiscord、plus_gopay、solana-pumpfun-bundler）+ 4 ⚠️（XHS、Polymarket × 2、教學 repo × 1+1）+ **7 ✅**（含 1 個顯著有意義）
> - **#9 rihebty/flow-kit ✅✨**：「融合 bmad、spec-kit、OpenSpec、GSD、claude-task-master、superpowers、gstack、skills」——**AI 編程 skill 整合框架**。整合多個既有 skill/spec/工作流的 meta-framework，與 [[src-andrej-karpathy-skills]]（單檔 CLAUDE.md）、[[src-mattpocock-skills]]（PRD/issue 模板）、[[src-addyosmani-agent-skills]]（SDLC skill 集合）形成不同層次：**flow-kit 是「skill 整合層」**，不發明 skill 而是組合
> - **#12 lightseekorg/tokenspeed ✅**：speed-of-light LLM inference engine——對應已建的 [[Inference.sh]] / [[src-dotLLM]]（C# inference）；推理引擎賽道持續火熱
> - **#11 TQ-trade-agent/taco-web ✅**：Threshold Access Control（去中心化加密的 proxy re-encryption）——少見的學術級密碼學專案
> - **WeritoP 帳號重複出現**（5/4 #1#2 + 5/6 #2）——同帳號刷榜延續，已成系統性 spam 模式
> - **Predictional-Infra 雙件 #6/#7 同帳號刷榜**——Polymarket bot 西文圈延續

## 2026-05-05

| # | Repo | 星 | 語言 | 主題 | 查核 | 連結 |
|---|------|----|------|------|------|------|
| 1 | skydoves/compose-animations | 67 | Kotlin | Jetpack Compose animations 集（hot-swap 即時調整） | ✅ | [GitHub](https://github.com/skydoves/compose-animations) |
| 2 | BuluBulugege/Free-BAI | 62 | TS | 無描述 | ⚠️ | [GitHub](https://github.com/BuluBulugege/Free-BAI) |
| 3 | shouryan01/Nikon-Recipes | 43 | — | 無描述（推測 Nikon 相機 recipes） | ⚠️ | [GitHub](https://github.com/shouryan01/Nikon-Recipes) |
| 4 | ~~JDMEXX/polymarket-bot~~ | ~~41~~ | ~~—~~ | ⚠️ Polymarket trading bot（Telegram alerts）灰色 | ⚠️ | [GitHub](https://github.com/JDMEXX/polymarket-bot) |
| 5 | ~~XBuilderLAB/cheat-on-content~~ | ~~32~~ | ~~Python~~ | ⚠️「Claude Code workflow 1M followers in 1 month」誇大宣傳 + 「cheat-code race」措辭可疑 | ⚠️ | [GitHub](https://github.com/XBuilderLAB/cheat-on-content) |
| 6 | huxiang1126/editorial-line-system | 20 | — | 無描述 | ⚠️ | [GitHub](https://github.com/huxiang1126/editorial-line-system) |
| 7 | Hacksore/cursed-repo | 19 | JS | 「Average JavaScript repo 🫪」（meta 笑話 repo） | ✅ | [GitHub](https://github.com/Hacksore/cursed-repo) |
| 8 | ~~gitlab-ai/best-ai-video-2026~~ | ~~16~~ | ~~—~~ | ❌「Best AI Video 2026」+ tinyurl + 「uncensored」標籤——SEO+垃圾鏈接 | ❌ | [GitHub](https://github.com/gitlab-ai/best-ai-video-2026) |
| 9 | zsj1029/LiteChat | 15 | TS | LiteChat（llama.cpp WebUI fork 支援 vLLM） | ✅ | [GitHub](https://github.com/zsj1029/LiteChat) |
| 10 | **lysiuchenko/wpf-buddy-mcp** | 15 | C# | **MCP server 讓 AI agents 透過 UI Automation 驅動/測試/檢視 WPF desktop 應用** | ✅ | [GitHub](https://github.com/lysiuchenko/wpf-buddy-mcp) |
| 11 | **louisedesadeleer/clipify** | 14 | Python | **Claude Code skill：把長影片變社群短片（自動找 funny 片段、9:16 reframe + face tracking + opus-style captions）** | ✅ | [GitHub](https://github.com/louisedesadeleer/clipify) |
| 12 | rdmsr/sectorllm | 13 | Assembly | The world's smallest llama2 inference engine（Assembly 寫的） | ✅ | [GitHub](https://github.com/rdmsr/sectorllm) |
| 13 | 1TDSPF-26/front-1sem-aula-02 | 13 | HTML | 無描述（教學/作業） | ⚠️ | [GitHub](https://github.com/1TDSPF-26/front-1sem-aula-02) |
| 14 | **win4r/goal-prompt-builder** | 13 | — | **Build audit-friendly /goal prompts for OpenAI Codex** | ✅ | [GitHub](https://github.com/win4r/goal-prompt-builder) |
| 15 | ~~Deesama22/FiveM-Steam-Edition~~ | ~~13~~ | ~~C++~~ | ❌ FiveM GTA 5 RP 盜版/客製化外掛 | ❌ | [GitHub](https://github.com/Deesama22/FiveM-Steam-Edition) |

> **05-05 觀察**——**信號略改善（5/3-5/6 三日中最佳的一日）**：
>
> - 15 條中：2 ❌（gitlab-ai 垃圾鏈、FiveM 外掛）+ 5 ⚠️（無描述/誇大/Polymarket bot）+ **8 ✅**（有意義專案）
> - **MCP / Codex skill 多件進榜**：
>   - **#10 wpf-buddy-mcp**——MCP server for WPF desktop UI Automation；補齊 Windows 桌面 agent 缺口（過去 MCP 多 Web/Linux 為主）
>   - **#11 clipify** Claude Code skill「長影片→社群短片」——對應 [[src-claude-for-creative-work]] 創意 connector + 5/4 PH #5 CC/Codex trading cards
>   - **#14 goal-prompt-builder for Codex**——「audit-friendly prompts」呼應 5/6 PH #4 pay.sh / Waydev ROI，Codex 工作流規範化趨勢
> - **多件 inference engine 同期出現**（5/6 tokenspeed + 5/5 LiteChat + 5/5 sectorllm + 5/5 wpf-buddy-mcp）——MCP/inference/agent 工具鏈同期擴張
> - **#1 skydoves/compose-animations 67 stars**——Android 開發者活躍，「hot-swap literals 即時調整動畫」設計工程實踐
> - **#5 XBuilderLAB/cheat-on-content ⚠️**：「1M followers in 1 month」+「cheat-code race」+「Claude Code workflow」混合：可信度待查核，但是 spam 化的「AI 內容工廠」承諾

## 2026-05-04

| # | Repo | 星 | 語言 | 主題 | 查核 | 連結 |
|---|------|----|------|------|------|------|
| 1 | ~~WeritoP/LInjector-FORKED-~~ | ~~459~~ | ~~—~~ | ❌ Luau Script IDE injector（Roblox 灰色） | ❌ | [GitHub](https://github.com/WeritoP/LInjector-FORKED-) |
| 2 | ~~WeritoP/FL-STUDIO-PATCHER~~ | ~~451~~ | ~~—~~ | ❌ FL Studio lifetime crack patcher（盜版破解） | ❌ | [GitHub](https://github.com/WeritoP/FL-STUDIO-PATCHER) |
| 3 | Composio-HQ/polymarket-kalshi-arbitrage-bot | 88 | TS | Polymarket Kalshi arbitrage bot；Composio 開發 | ⚠️ | [GitHub](https://github.com/Composio-HQ/polymarket-kalshi-arbitrage-bot) |
| 4 | bestpracticaI/kalshi-ai-trading-bot | 85 | TS | Kalshi AI trading bot（OpenRouter LLM + RSA + npm） | ⚠️ | [GitHub](https://github.com/bestpracticaI/kalshi-ai-trading-bot) |
| 5 | amanning3390/deepswarm | 72 | Python | 無描述 | ⚠️ | [GitHub](https://github.com/amanning3390/deepswarm) |
| 6 | Michaelliv/pi-goal | 56 | TS | Persistent autonomous goals for pi（Pi 個人 AI 助理 agent goals） | ✅ | [GitHub](https://github.com/Michaelliv/pi-goal) |
| 7 | pixelxzen/phantom-motion | 49 | HTML | Interactive dynamic visual storytelling generator（中英文宣傳） | ⚠️ | [GitHub](https://github.com/pixelxzen/phantom-motion) |
| 8 | ~~JadenMassari/pumpfun-memecoin-sniper~~ | ~~45~~ | ~~—~~ | ❌ Solana memecoin sniper bot（Jito bundles + anti-rug + MEV） | ❌ | [GitHub](https://github.com/JadenMassari/pumpfun-memecoin-sniper) |
| 9 | **petergpt/codex-pet-limit-rings** | 37 | Swift | **Codex pet 顯示用量限制環**——對應 PH 5/4 #2 Codex Pets 動畫夥伴 | ✅ | [GitHub](https://github.com/petergpt/codex-pet-limit-rings) |
| 10 | ethgan/Cloudflare_TextSpace_Worker | 28 | JS | Cloudflare 文本直鏈網盤（中文，CDN 加速） | ⚠️ | [GitHub](https://github.com/ethgan/Cloudflare_TextSpace_Worker) |
| 11 | iamagenius00/wild-week-athens-26 | 26 | TS | Codex-reconstructed clone of Wild Week Athens 2026 page | ✅ | [GitHub](https://github.com/iamagenius00/wild-week-athens-26) |
| 12 | joshawome/chainreason | 24 | Python | LLM reasoning on Ethereum and DeFi tasks benchmark | ✅ | [GitHub](https://github.com/joshawome/chainreason) |
| 13 | moxailoo/univ3-pool-lens | 24 | TS | Uniswap V3 pool inspect TS toolkit | ✅ | [GitHub](https://github.com/moxailoo/univ3-pool-lens) |
| 14 | butthtio/solidity-cot-auditor | 24 | Python | Multi-role chain-of-thought LLM pipeline for Solidity security | ✅ | [GitHub](https://github.com/butthtio/solidity-cot-auditor) |
| 15 | 1TDSPG-26/front-aula3-1sem | 23 | CSS | 無描述（教學/作業 repo） | ⚠️ | [GitHub](https://github.com/1TDSPG-26/front-aula3-1sem) |

> **05-04 觀察**——**信號劣化但分布變多元**：
>
> - 15 條中：3 ❌（WeritoP × 2 + pumpfun-memecoin-sniper）+ 5 ⚠️（Polymarket/Kalshi × 2 + 無描述 × 3）+ **7 ✅**（含 1 條延續主題）
> - **WeritoP 帳號刷榜**：#1 LInjector-FORKED + #2 FL-STUDIO-PATCHER 同帳號雙件刷榜進前 2，459+451 stars 異常高（同帳號平均 stars 偏高的指標）
> - **Polymarket / Kalshi prediction market bots 雙件 #3+#4**：5/5 又出現 #4 polymarket-bot，5/6 又出現 #6/#7 Predictional-Infra 雙件——**3 日 4+ 件 prediction market 相關 bot**，主題持續性顯著
> - **#9 petergpt/codex-pet-limit-rings ✅**：對應同日 PH #2 Codex Pets——**從「動畫」延伸到「實用功能」**（usage limit 視覺化）；開發者文化從幽默到工具化
> - **#6 Michaelliv/pi-goal**——Pi（[Pi.ai](https://pi.ai/) Inflection AI 助理）的「persistent autonomous goals」；對應 [[src-bug-hunter]] 跨 7+ 平台支援中提到的 Pi Coding Agent
> - **DeFi/Crypto 工程主題多件 ✅**：#12 chainreason（LLM reasoning on Ethereum）+ #13 univ3-pool-lens + #14 solidity-cot-auditor——區塊鏈正規工程持續累積（與灰色 sniper bot 形成對比）
> - **#11 iamagenius00/wild-week-athens-26**——Codex-reconstructed page 範例；agent 重構網站的 demo

## 2026-05-03 ⚠️ 信號崩壞日

| # | Repo | 星 | 語言 | 主題 | 查核 | 連結 |
|---|------|----|------|------|------|------|
| 1 | JustLikeCheese/LGBT-Prompt | 151 | — | 無描述 | ⚠️ | [GitHub](https://github.com/JustLikeCheese/LGBT-Prompt) |
| 2 | ~~Meow-Calculations/DeepSeek_Web_To_API~~ | ~~23~~ | ~~Go~~ | ❌ DeepSeek API 灰色繞過工具 | ❌ | [GitHub](https://github.com/Meow-Calculations/DeepSeek_Web_To_API) |
| 3 | ~~geage13/luna-cheat-menu.github.io~~ | ~~22~~ | ~~—~~ | ❌ GTA V mod menu / 作弊工具 | ❌ | [GitHub](https://github.com/geage13/luna-cheat-menu.github.io) |
| 4 | ~~hugomessier2015/Instalar-Trampas-para-CS2-2026~~ | ~~22~~ | ~~—~~ | ❌ CS2 aimbot 西文外掛 | ❌ | [GitHub](https://github.com/hugomessier2015/Instalar-Trampas-para-CS2-2026-Punter-a-Autom-tica-Visi-n-Total-y-M-s) |
| 5 | ~~worapog/kahoot-auto-answer-bot~~ | ~~22~~ | ~~—~~ | ❌ Kahoot 課堂作弊 bot | ❌ | [GitHub](https://github.com/worapog/kahoot-auto-answer-bot) |
| 6 | gimgyeon/loader-openclaw-skills | 22 | — | OpenClaw skill 自動安裝管理器（5,200+ 社群 skill from ClawHub），Windows only | ⚠️ | [GitHub](https://github.com/gimgyeon/loader-openclaw-skills) |
| 7 | ~~hugomessier2015/Instalar-Punter-a-Autom-tica-CS2-2026~~ | ~~22~~ | ~~—~~ | ❌ 同 #4 同帳號刷榜 CS2 aimbot | ❌ | [GitHub](https://github.com/hugomessier2015/-Instalar-Punter-a-Autom-tica-para-CS2-2026-Aimbot-Indetectable) |
| 8 | ~~fronekzv/Instalar-Cambiador-Identificacion-Hardware-R6S~~ | ~~22~~ | ~~—~~ | ❌ R6S HWID spoofer 反封鎖 | ❌ | [GitHub](https://github.com/fronekzv/Instalar-Cambiador-de-Identificacion-de-Hardware-para-R6S-2026-Spoofer-Indetectable) |
| 9 | ~~bbangbread123/Trampas-R6S-2026~~ | ~~22~~ | ~~—~~ | ❌ R6S aimbot/wallhack | ❌ | [GitHub](https://github.com/bbangbread123/Trampas-para-R6S-2026-Punter-a-Autom-tica-Visi-n-a-Trav-s-de-Paredes-y-M-s-Totalmente-Indetectable) |
| 10 | ~~fronekzv/Install-Fortnite-Aimbot-2026~~ | ~~22~~ | ~~—~~ | ❌ Fortnite aimbot（標「FOR EDUCATIONAL ONLY」掩飾） | ❌ | [GitHub](https://github.com/fronekzv/FOR-EDUCATIONAL-RESEARCH-ONLY-Install-Fortnite-Aimbot-2026-Undetectable-Aim-Assist) |
| 11 | ~~baohungprosh1/R6-Recoil-Control-Aim-bot-Research~~ | ~~22~~ | ~~—~~ | ❌ R6S aim bot（同上） | ❌ | [GitHub](https://github.com/baohungprosh1/R6-Recoil-Control-Aim-bot-Assist-Research-2026-) |
| 12 | ~~cyruss0804/Descargar-Trampas-Fortnite-2026~~ | ~~22~~ | ~~—~~ | ❌ Fortnite aimbot 西文版 | ❌ | [GitHub](https://github.com/cyruss0804/Descargar-Trampas-para-Fortnite-2026-Punteria-Autom-tica-Vision-Total-y-Mas) |
| 13 | ~~hugomessier2015/CS2-2026-Vision-Total-Wallhack~~ | ~~22~~ | ~~—~~ | ❌ CS2 wallhack | ❌ | [GitHub](https://github.com/hugomessier2015/Instalar-Visi-n-Total-para-CS2-2026-Ve-a-Todos-a-Trav-s-de-Paredes) |
| 14 | ~~fronekzv/R6S-Wallhack-Indetectable~~ | ~~22~~ | ~~—~~ | ❌ R6S wallhack | ❌ | [GitHub](https://github.com/fronekzv/Instalar-Visi-n-a-Trav-s-de-Paredes-para-R6S-2026-Wallhack-Indetectable) |
| 15 | Optimus1200/Ace_Combat_Infinity_Campaign_Patch | 21 | C# | 私服伺服器（Ace Combat Infinity 已停服遊戲復活） | ⚠️ | [GitHub](https://github.com/Optimus1200/Ace_Combat_Infinity_Campaign_Patch_and_Local_Server) |

> **05-03 觀察**——**GitHub Trending 信號徹底崩壞日**：
>
> - 15 條中 **11 條 ❌**（10 條 FPS 遊戲外掛/盜版西文 SEO + 1 條 LLM API 繞過）+ 3 條 ⚠️（無描述/灰色）+ 僅 1 條 ⚠️ 灰色但有意義（gimgyeon/loader-openclaw-skills）
> - **手法分析**：
>   - hugomessier2015 / fronekzv 帳號**重複衝榜**（CS2/R6S 多件 22 stars 同步進榜）
>   - **「FOR EDUCATIONAL ONLY」「Indetectable」「Research」**等掩飾詞已成標準 spam 用語
>   - 西班牙語/葡萄牙語標題針對拉美遊戲玩家市場
> - **與 [[src-github-trending-2026-05]] 5/1 #10/#14/#15** 詐騙模式延續，但 5/3 規模性更系統化
> - **下游影響**：trending 信號完全失效；任何依賴它的工具（[[src-multica-devv-ai盡調]] 中提到的 OSS 投資 Star 健康度評分）需重新校正

## 2026-05-02

| # | Repo | 星 | 語言 | 主題 | 查核 | 連結 |
|---|------|----|------|------|------|------|
| 1 | vibeforge1111/keep-codex-fast | 118 | Python | backup-first Codex skill：保持本地 Codex 狀態快、乾淨、可恢復 | ✅ | [GitHub](https://github.com/vibeforge1111/keep-codex-fast) |
| 2 | ~~CloakdDev/solana-go~~ | ~~54~~ | ~~Go~~ | 無描述（同 #4 #6 同帳號 Solana 系列） | ⚠️ | [GitHub](https://github.com/CloakdDev/solana-go) |
| 3 | Teaonly/SKILL.make | 45 | Shell | Makefile-formatted Agent Skills 規範與工具——agent skill 的 packaging 格式提案 | ✅ | [GitHub](https://github.com/Teaonly/SKILL.make) |
| 4 | ~~CloakdDev/sol_buddy~~ | ~~34~~ | ~~JS~~ | 無描述（同 #2 #6 帳號） | ⚠️ | [GitHub](https://github.com/CloakdDev/sol_buddy) |
| 5 | ~~jfinal/aifei~~ | ~~32~~ | ~~Java~~ | ⚠️ 「世界首個 AI coding framework」自誇但無證據（jfinal 是 Java framework 老 repo） | ⚠️ | [GitHub](https://github.com/jfinal/aifei) |
| 6 | ~~CloakdDev/raydium-frontend~~ | ~~23~~ | ~~TS~~ | 無描述（同 #2 #4 帳號 Solana DeFi 系列，疑刷榜） | ⚠️ | [GitHub](https://github.com/CloakdDev/raydium-frontend) |
| 7 | crafter-station/petdex | 22 | TS | Codex pets 動畫 gallery：開發者工具寵物化趨勢 | ✅ | [GitHub](https://github.com/crafter-station/petdex) |
| 8 | matthart1983/syswatch | 22 | Rust | 單機系統診斷 TUI（netwatch 兄弟），12 tabs，session scrubber，macOS+Linux | ✅ | [GitHub](https://github.com/matthart1983/syswatch) |
| 9 | Aestheticsuraj234/chaicode-mobiledev-2026 | 15 | JS | 無描述 | ⚠️ | [GitHub](https://github.com/Aestheticsuraj234/chaicode-mobiledev-2026) |
| 10 | 18Xufeng/SCOPE | 14 | Python | 無描述 | ⚠️ | [GitHub](https://github.com/18Xufeng/SCOPE) |
| 11 | backnotprop/codex-pets-react | 14 | TS | Declarative React wrapper for Codex pet spritesheets（與 #7 同主題） | ✅ | [GitHub](https://github.com/backnotprop/codex-pets-react) |
| 12 | derealisation/isabelline | 14 | Lean | 用 Lean 寫的 typed stack machine bytecode 驗證器——形式驗證／編譯器研究 | ✅ | [GitHub](https://github.com/derealisation/isabelline) |
| 13 | ~~mrdrvt99/YouProEXTRA~~ | ~~13~~ | ~~—~~ | ❌ YouTube 解鎖 IPA 盜版工具 | ❌ | [GitHub](https://github.com/mrdrvt99/YouProEXTRA) |
| 14 | senator715/RijiN | 13 | C++ | 「Full source code for RijiN/codebase_main」描述空泛 | ⚠️ | [GitHub](https://github.com/senator715/RijiN) |
| 15 | ~~Stintik-Official/StintikVPN-~~ | ~~12~~ | ~~—~~ | 無描述 + VPN 名稱（疑詐騙/惡意） | ⚠️ | [GitHub](https://github.com/Stintik-Official/StintikVPN-) |

> **05-02 觀察**：
>
> - 真有價值 6 條（#1, #3, #7, #8, #11, #12），佔 40%；CloakdDev 同帳號 3 件 Solana repo 進榜（疑刷榜）
> - **Codex pets 主題雙件進榜**（#7 petdex + #11 codex-pets-react）——OpenAI Codex 的開發者文化「給 agent 一個寵物」的視覺化趨勢；對應 [[src-oh-my-codex]] 中 Codex CLI 的 harness 工具生態
> - **#1 keep-codex-fast**——「Codex local state 快取維護」skill，呼應 Codex 為 local-first agent 的設計
> - **#3 SKILL.make**——Agent Skill packaging 格式提案（Makefile-formatted），與既有 skills.sh / [[Claude Code]] / OpenClaw skill format 形成 fragmented standard 競爭
> - **#8 syswatch**——Rust TUI 工具實踐連續趨勢；對 [[src-codeburn]]（AI coding token 觀測 TUI）形成「TUI 復興」共軌
> - **#12 isabelline**——Lean 形式驗證罕見上 trending；學術社群獨立崛起
