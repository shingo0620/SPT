...
### 抗 LLM 風格的 indie 哲學
- **與 [[src-Solo SaaS架構|Solo SaaS架構]] / [[levelsio]] / [[antfu]]**：「我可能不會釋出、不收 GitHub stars、自己用就好」的 indie 態度——對抗「每個 OSS 都該規模化」的預設
...
- [[src-Solo SaaS架構|Solo SaaS架構]] / [[antfu]] / [[levelsio]]（indie 開發者哲學）
