...
- ⭐ **2026-05-19 招募 [[Andrej Karpathy]]**（[[src-hn-2026-05]] HN #3，477 分；TechCrunch/CNBC/Axios 證實）：OpenAI 創始成員、前 Tesla AI 總監、[[LLM Wiki]] 提出者加入 **pre-training 團隊**（lead Nick Joseph），組建「用 Claude 加速 pre-training 研究」團隊。AI 頂尖人才競逐中的指標性招募——Anthropic 持續成為精英技術人才磁石
...
- [[src-anthropic-managed-agents]]（Managed Agents PM 視角）／ [[src-scaling-managed-agents]]（Managed Agents 工程實作：brain/hands/session 解耦、meta-harness、TTFT 降 60-90%）
